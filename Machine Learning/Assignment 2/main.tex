...
\begin{flalign}
\ln p(\textbf{w}) &= -\frac{M}{2} \ln(2\pi\alpha) - \frac{\alpha}{2}\textbf{w}^{T}\textbf{w} \notag \\
&= -\frac{\alpha}{2}\textbf{w}^{T}\textbf{w} + C_{2} \label{eq:11}
&&
\end{flalign}
...
\begin{flalign}
\ln p(\textbf{w} \mid \mathcal{D}) &= \frac{1}{2} \left(2\bm{\tau}^{T} \textbf{D}^{-1} \bm{\Phi} \textbf{w} - \textbf{w}^{T} \bm{\Phi}^{T} \textbf{D}^{-1} \bm{\Phi} \textbf{w} + C_{1} \right)  - \frac{\alpha}{2}\textbf{w}^{T}\textbf{w} + C_{2} +  C_{3} \notag \\
&= \frac{1}{2} \left(2\bm{\tau}^{T} \textbf{D}^{-1} \bm{\Phi} \textbf{w} - \textbf{w}^{T} \bm{\Phi}^{T} \textbf{D}^{-1} \bm{\Phi} \textbf{w} \right) -\frac{\alpha}{2}\textbf{w}^{T}\textbf{w} + C \label{eq:13}
&&
\end{flalign}
