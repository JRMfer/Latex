...
& = \mathcal{N}(\bm{\Psi}\textbf{w}, \bm{\Omega}) \notag \\ 
& = \frac{1}{(2\pi)^{\frac{N}{2}}\text{det}(\bm{\Omega})^{\frac{1}{2}}} \mathrm{e}^{-\frac{1}{2}\bigl[(\textbf{t} - \bm{\Psi}\textbf{w})^{T}\bm{\Omega}^{-1}(\textbf{t} - \bm{\Psi}\textbf{w})\bigr]} \label{eq:1}
&&
\end{flalign}
...
\begin{flalign}
p(\textbf{D} \mid \bm{\theta}) &= \frac{1}{(2\pi)^{\frac{N}{2}}\text{det}(\bm{\Omega})^{\frac{1}{2}}} \mathrm{e}^{-\frac{1}{2}\bigl[(\textbf{t} - \bm{\Psi}\textbf{w})^{T}\bm{\Omega}^{-1}(\textbf{t} - \bm{\Psi}\textbf{w})\bigr]} \notag \\
&= \frac{1}{(2\pi)^{\frac{N}{2}}\text{det}(\textbf{D})^{\frac{1}{2}}} \mathrm{e}^{-\frac{1}{2}\bigl[(\textbf{t} - \bm{\Psi}\textbf{w})^{T}\textbf{A}^{T}\textbf{D}^{-1}\textbf{A}(\textbf{t} - \bm{\Psi}\textbf{w})\bigr]} \notag \\
&= \frac{1}{(2\pi)^{\frac{N}{2}}\text{det}(\textbf{D})^{\frac{1}{2}}} \mathrm{e}^{-\frac{1}{2}\bigl[(\textbf{t}^{T} \textbf{A}^{T} \textbf{D}^{-1}\textbf{At} - \textbf{t}^{T}\textbf{A}^{T} \textbf{D}^{-1}\textbf{A} \bm{\Psi} \textbf{w} - \textbf{w}^{T} \bm{\Psi}^{T} \textbf{A}^{T} \textbf{D}^{-1}\textbf{At} + \textbf{w}^{T} \bm{\Psi}^{T} \textbf{A}^{T} \textbf{D}^{-1}\textbf{A} \bm{\Psi} \textbf{w})\bigr]} \notag \\
&= \frac{1}{(2\pi)^{\frac{N}{2}}\text{det}(\textbf{D})^{\frac{1}{2}}} \mathrm{e}^{-\frac{1}{2}\bigl[(\bm{\tau}^{T} \textbf{D}^{-1} \bm{\tau} - \bm{\tau}^{T} \textbf{D}^{-1} \bm{\Phi} \textbf{w} - \textbf{w}^{T} \bm{\Phi}^{T}\textbf{D}^{-1} \bm{\tau} + \textbf{w}^{T} \bm{\Phi}^{T} \textbf{D}^{-1} \bm{\Phi} \textbf{w})\bigr]} ~~~~\text{(with $\bm{\tau} \coloneqq$ \textbf{At} and $\bm{\Phi} \coloneqq$ \textbf{A} $\bm{\Psi}$)} \notag \\
&= \frac{1}{(2\pi)^{\frac{N}{2}}\text{det}(\textbf{D})^{\frac{1}{2}}} \mathrm{e}^{-\frac{1}{2}\bigl[(\bm{\tau}^{T} \textbf{D}^{-1} \bm{\tau} - 2\bm{\tau}^{T} \textbf{D}^{-1} \bm{\Phi} \textbf{w} + \textbf{w}^{T} \bm{\Phi}^{T} \textbf{D}^{-1} \bm{\Phi} \textbf{w})\bigr]} \notag \\
&= 
&&
\end{flalign}
